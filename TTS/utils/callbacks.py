class TrainerCallback:
    ...
    def on_epoch_start(self) -> None:  # pylint: disable=no-self.trainer-use
    ...
    def on_epoch_end(self) -> None:  # pylint: disable=no-self.trainer-use
    ...
    def on_train_step_start(self) -> None:  # pylint: disable=no-self.trainer-use
    ...
    def on_train_step_end(self) -> None:  # pylint: disable=no-self.trainer-use
    ...
    def on_keyboard_interrupt(self) -> None:  # pylint: disable=no-self.trainer-use
